                                ...
                                <form method="post" action="<%=request.getContextPath()%>/front_end/mem/sendMail">
                                    <div class="form-card">
                                        <div class="row">
                                            ...
                                            <div style="color: red;">${requestScope.error_msg}</div>
                                        </div>
                                        <label class="fieldlabels">請輸入新密碼:</label><div style="color: red;">${requestScope.newPassword_error}</div>
                                        <input type="password" name="newPassword" value="${param.newPassword}"  required>
                                        <label class="fieldlabels">再次輸入新密碼</label><div style="color: red;">${requestScope.newPassword2_error}</div>
                                        <input type="password" name="newPassword2" value="${param.newPassword2}" required>
                                    </div>
                                    <input type="hidden" name="action" value="reset_password" />
                                    <button type="submit" class="action-button" >確定</button>
                                </form>
                            </div>
                        </div>
                    </div>
