                        ...
                        <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                            ...
                            <div id="msform">
                                ...
                                <ul id="progressbar">
                                    ...
                                    <li id="personal"><strong>接收驗證碼</strong></li>
                                    <li id="payment"><strong>修改密碼</strong></li>
                                    <li id="confirm"><strong>成功</strong></li>
                                </ul>

                                <br>
                                <!-- fieldsets -->
                                <form method="post" action="<%=request.getContextPath()%>/front_end/mem/sendMail">
                                    <div class="form-card">
                                        <div class="row">
                                            <div class="col-7">
                                            ...
                                            <div style="color: red;">${requestScope.sedEmail_error}</div>
                                        </div>
                                        <label class="fieldlabels">帳號:</label><div style="color: red;">${requestScope.memberAccount_error}</div>
                                        <input type="text" name="memberAccount" value="${param.memberAccount}" placeholder="請輸入使用的帳號" required/>
                                        <label class="fieldlabels">Email:</label><div style="color: red;">${requestScope.memberEmail_error}</div>
                                        <input type="mail" name="memberEmail" value="${param.memberEmail}" placeholder="請輸入註冊時的信箱" required/>
                                    </div>
                                    <input type="hidden" name="action" value="send_code" />
                                    <button type="submit"  class="action-button" >發送驗證碼</button>
