                            ...
                            <div id="msform">
                                ...
                                <form method="post" action="<%=request.getContextPath()%>/front_end/mem/sendMail">
                                    <div class="form-card">
                                        ...
                                        <label class="fieldlabels">請輸入驗證碼:</label><div style="color: red;">${requestScope.code_error}</div>
                                        <input type="text" name="emailCode" placeholder="輸入驗證碼" requried/>
                                    </div>
                                    <input type="hidden" name="action" value="verify_code" />
                                    <button type="submit"  class=" action-button" >驗證</button>
                                </form>
                            </div>
                        </div>
                    </div>
